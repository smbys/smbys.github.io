...
jQuery(document).ready(function() {
  ...
  $("#torsioncrowds.backstretched").backstretch(["assets/images/torsioncrowds/slide-1.gif", "assets/images/torsioncrowds/slide-2.jpeg",  ], {
    duration: 6000,
    fade: 1200
  });
  ...
  $("a[href*=#prev-slide]").on("click",function(event) {
      event.preventDefault(); 
      jQuery('#torsioncrowds.backstretched').data('backstretch').prev();
    });
  $("a[href*=#next-slide]").on("click",function(event) {
      event.preventDefault(); 
      jQuery('#torsioncrowds.backstretched').data('backstretch').next();
  });
